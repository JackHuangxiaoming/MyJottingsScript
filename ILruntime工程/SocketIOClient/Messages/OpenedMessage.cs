...
namespace SocketIOClient.Messages
{
    public class OpenedMessage : IMessage
    {
        ...
        private int GetInt32FromJsonElement(JsonElement element, string msg, string name)
         //private int GetInt32FromJsonElement(MyJson.IJsonNode element, string msg, string name)
        {
            ...
            return val;
            //var p = element.Get(name);
            //int val;
            //switch (p.type)
            //{
            //    case MyJson.jsontype.Value_String:
            //        val = int.Parse(p.AsString());
            //        break;
            //    case  MyJson.jsontype.Value_Number:
            //        val = p.AsInt();
            //        break;
            //    default:
            //        throw new ArgumentException($"Invalid message: '{msg}'");
