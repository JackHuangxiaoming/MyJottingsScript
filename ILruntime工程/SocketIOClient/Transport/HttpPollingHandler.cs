...
namespace SocketIOClient.Transport
{
    public abstract class HttpPollingHandler : IHttpPollingHandler
    {
        public HttpPollingHandler(HttpClient httpClient)
        {
            ...
            //TextSubject = new List<string>();
            //BytesSubject = new List<byte[]>();
        ...
        //protected List<string> TextSubject { get; }
        //protected List<byte[]> BytesSubject { get; }
        ...
        private void ProduceBytes(byte[] bytes)
        {
            ...
            while (bytes.Length > i + 4)
            {
                ...
                if (type == 0)
                {
                    ...
                    //TextSubject.Add(Encoding.UTF8.GetString(buffer));
                }
                else if (type == 1)
                {
