...
namespace SocketIOClient
{
    ...
    //public delegate void OnAck(int packetId, List<MyJson.IJsonNode> array);
    //public delegate void OnBinaryAck(int packetId, int totalCount, List<MyJson.IJsonNode> array);
    //public delegate void OnBinaryReceived(int packetId, int totalCount, string eventName, List<MyJson.IJsonNode> array);
    public delegate void OnDisconnected();
    public delegate void OnError(string error);
    public delegate void OnEventReceived(int packetId, string eventName, List<JsonElement> array);
    //public delegate void OnEventReceived(int packetId, string eventName, List<MyJson.IJsonNode> array);
