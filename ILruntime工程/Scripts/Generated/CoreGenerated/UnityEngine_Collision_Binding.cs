...
{
    unsafe class UnityEngine_Collision_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Collision);
            args = new Type[]{};
            method = type.GetMethod("get_rigidbody", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_rigidbody_0);
            args = new Type[]{};
        ...
        static StackObject* get_rigidbody_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
