...
{
    unsafe class System_Action_2_GComponent_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Action<FairyGUI.GComponent, ILRuntime.Runtime.Intepreter.ILTypeInstance>);
            args = new Type[]{typeof(FairyGUI.GComponent), typeof(ILRuntime.Runtime.Intepreter.ILTypeInstance)};
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Action<FairyGUI.GComponent, ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method = (System.Action<FairyGUI.GComponent, ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(System.Action<FairyGUI.GComponent, ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
