...
{
    unsafe class System_Threading_Tasks_Task_1_FunctionResponse_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Threading.Tasks.Task<CloudBase.FunctionResponse>);
            args = new Type[]{};
        ...
        static StackObject* get_Result_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Threading.Tasks.Task<CloudBase.FunctionResponse> instance_of_this_method = (System.Threading.Tasks.Task<CloudBase.FunctionResponse>)typeof(System.Threading.Tasks.Task<CloudBase.FunctionResponse>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
