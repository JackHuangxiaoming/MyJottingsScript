...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GRoot_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_soundVolume_2);
        ...
        static StackObject* SetContentScaleFactor_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.UIContentScaler.ScreenMatchMode @screenMatchMode = (FairyGUI.UIContentScaler.ScreenMatchMode)typeof(FairyGUI.UIContentScaler.ScreenMatchMode).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
        ...
        static StackObject* set_soundVolume_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
