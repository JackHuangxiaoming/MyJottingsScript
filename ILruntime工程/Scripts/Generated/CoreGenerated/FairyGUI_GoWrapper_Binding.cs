...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GoWrapper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UnityEngine.GameObject), typeof(System.Boolean), typeof(System.Action)};
            method = type.GetMethod("SetWrapTarget", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetWrapTarget_1);
            args = new Type[]{};
            method = type.GetMethod("RecoverMaterials", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, RecoverMaterials_2);
            args = new Type[]{typeof(UnityEngine.GameObject)};
            method = type.GetMethod("set_wrapTarget", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_wrapTarget_3);
        ...
        static StackObject* SetWrapTarget_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action @cloneCallBack = (System.Action)typeof(System.Action).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.SetWrapTarget(@target, @cloneMaterial, @cloneCallBack);

            return __ret;
        }

        static StackObject* RecoverMaterials_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            instance_of_this_method.RecoverMaterials();

            return __ret;
        }

        static StackObject* set_wrapTarget_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new FairyGUI.GoWrapper(@go, @cloneMaterial, @cloneCallBack);
