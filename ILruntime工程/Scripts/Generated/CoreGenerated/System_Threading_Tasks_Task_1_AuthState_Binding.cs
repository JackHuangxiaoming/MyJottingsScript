...
{
    unsafe class System_Threading_Tasks_Task_1_AuthState_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Threading.Tasks.Task<CloudBase.AuthState>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Threading.Tasks.Task<CloudBase.AuthState> instance_of_this_method = (System.Threading.Tasks.Task<CloudBase.AuthState>)typeof(System.Threading.Tasks.Task<CloudBase.AuthState>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
