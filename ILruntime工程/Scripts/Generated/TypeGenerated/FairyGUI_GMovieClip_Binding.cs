...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GMovieClip_Binding
    {
        ...
        static StackObject* set_flip_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            FairyGUI.FlipType @value = (FairyGUI.FlipType)typeof(FairyGUI.FlipType).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* SyncStatus_18(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            FairyGUI.GMovieClip @anotherMc = (FairyGUI.GMovieClip)typeof(FairyGUI.GMovieClip).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
