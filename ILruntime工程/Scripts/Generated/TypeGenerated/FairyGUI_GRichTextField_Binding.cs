...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GRichTextField_Binding
    {
        ...
        static StackObject* get_richTextField_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.GRichTextField instance_of_this_method = (FairyGUI.GRichTextField)typeof(FairyGUI.GRichTextField).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* set_emojies_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.Dictionary<System.UInt32, FairyGUI.Emoji> @value = (System.Collections.Generic.Dictionary<System.UInt32, FairyGUI.Emoji>)typeof(System.Collections.Generic.Dictionary<System.UInt32, FairyGUI.Emoji>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
